...
export const Footer: React.FC = () => {
  ...
  const youtubeUrl = siteSettings?.youtube_url || 'https://www.youtube.com/@govalyshop';

  const rawWhatsapp = siteSettings?.whatsapp_number || '+8801805101868';
  const whatsappUrl = rawWhatsapp.startsWith('http')
    ? rawWhatsapp
    : `https://wa.me/${rawWhatsapp.replace(/[^0-9]/g, '')}`;

  const playStoreUrl = siteSettings?.play_store_url || 'https://play.google.com/store/apps/details?id=com.ekhanei.customer.app&pcampaignid=web_share';
  const appStoreUrl = siteSettings?.app_store_url || 'https://apps.apple.com/app/govaly/id6757096963';
  const copyrightText = siteSettings?.footer_copyright_text || '© EkhaneiLimited';
  const showPaymentMethods = siteSettings?.show_payment_methods !== '0';
              ...
              <div className="text-[16px] md:w-fit px-3 md:px-0 text-left">
                <div className="hidden md:block">
                  ...
                  <ul className="space-y-1 min-w-[120px]">
                    {facebookUrl && (
                      <li>
                        <a className="flex items-center gap-2 hover:text-[#E2136E] transition-colors" target="_blank" rel="noopener noreferrer" href={facebookUrl}>
                    ...
                    {instagramUrl && (
                      <li>
                        <a className="flex items-center gap-2 hover:text-[#E2136E] transition-colors" target="_blank" rel="noopener noreferrer" href={instagramUrl}>
                    ...
                    {tiktokUrl && (
                      <li>
                        <a className="flex items-center gap-2 hover:text-[#E2136E] transition-colors" target="_blank" rel="noopener noreferrer" href={tiktokUrl}>
                    ...
                    {youtubeUrl && (
                      <li>
                        <a className="flex items-center gap-2 hover:text-[#E2136E] transition-colors" target="_blank" rel="noopener noreferrer" href={youtubeUrl}>
                ...
                <div className="md:hidden border-b border-slate-200 py-2">
                  ...
                  {openSection === 'social' && (
                    <ul className="mt-2 space-y-1.5 text-sm text-slate-600 pl-1">
                      {facebookUrl && <li><a className="hover:text-[#d81b60]" target="_blank" rel="noopener noreferrer" href={facebookUrl}>Facebook</a></li>}
                      {instagramUrl && <li><a className="hover:text-[#d81b60]" target="_blank" rel="noopener noreferrer" href={instagramUrl}>Instagram</a></li>}
                      {tiktokUrl && <li><a className="hover:text-[#d81b60]" target="_blank" rel="noopener noreferrer" href={tiktokUrl}>TikTok</a></li>}
                      {youtubeUrl && <li><a className="hover:text-[#d81b60]" target="_blank" rel="noopener noreferrer" href={youtubeUrl}>YouTube</a></li>}
                      {whatsappUrl && <li><a className="hover:text-[#d81b60]" target="_blank" rel="noopener noreferrer" href={whatsappUrl}>WhatsApp</a></li>}
                    </ul>
                  )}
                </div>
              </div>
