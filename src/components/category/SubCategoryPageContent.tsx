        ...
        <section className="space-y-3 pt-2">
          ...
          <div className="flex gap-3 sm:gap-4 md:gap-5 overflow-x-auto no-scrollbar pb-1 pt-0.5 px-0.5 snap-x">
            {subCategories.map((sub: any) => (
              ...
              >
                <div className="w-[85px] h-[85px] sm:w-[105px] sm:h-[105px] md:w-[130px] md:h-[130px] lg:w-[145px] lg:h-[145px] rounded-2xl sm:rounded-3xl overflow-hidden bg-slate-100 group-hover:shadow-md transition-all duration-300 relative border-2 border-transparent hover:border-emerald-400">
                  {sub.image ? (
                    <img
