            ...
            >
              ...
              {isUnavailable && (
                <div className="absolute inset-0 bg-slate-950/65 backdrop-blur-[2px] z-20 flex flex-col items-center justify-center p-3 text-center transition-all duration-300 pointer-events-none">
                  ...
                  <span className="mt-1.5 text-white/95 font-bold text-xs sm:text-sm bg-black/50 px-3 py-1.5 rounded-lg backdrop-blur-md border border-white/15 flex items-center gap-1.5 shadow-xs">
